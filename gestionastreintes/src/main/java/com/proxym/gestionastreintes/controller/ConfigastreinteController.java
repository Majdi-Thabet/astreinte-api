...
public class ConfigastreinteController {
        ...
        //creating a get mapping that retrieves all the configs detail from the database
        @GetMapping("/getallconfigastreinte")
        private List<Configastreinte> getAllConfigs()
        {
            return configastreinteService.getAllConfigs();
        }
        //creating a get mapping that retrieves the detail of a specific configastreinte
...
//    private Configastreinte getTotal(@PathVariable("id") long id,@PathVariable("idastreinte") long idastreinte,@PathVariable("idcollab") long idcollab)
//    {
...
//    }
        ...
        private Configastreinte saveConfigastreinte(@RequestBody Configastreinte configastreinte,@PathVariable("idcollab")Long idcollab)
        {
    ...
    public ResponseEntity<Configastreinte> update(@PathVariable("id") long id,@RequestBody Configastreinte configastreinte){
...
//        @PutMapping("/configastreinte/{id}")
//        private Configastreinte update(@RequestBody Configastreinte configastreinte,@PathVariable("id")Long id)
//        {
//
