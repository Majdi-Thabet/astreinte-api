...
public class DemandeastreinteController {
    ...
    // creating a get mapping that retrieves all the demandeastreinte detail from
    // the database
    ...
    private Demandeastreinte savedemandeastreinte(@RequestBody Demandeastreinte demandeastreinte,
            @PathVariable("idcollab") Long idcollab, @PathVariable("idastreinte") Long idastreinte) {
    ...
    // private Demandeastreinte
    // pendingdemandeastreinte(@PathVariable("iddemande")Long iddemande)
    // {
    ...
    public ResponseEntity<Demandeastreinte> update(@PathVariable("id") long id,
            @RequestBody Demandeastreinte demandeastreinte) {
